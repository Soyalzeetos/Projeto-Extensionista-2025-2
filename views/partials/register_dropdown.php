    ...
    <form action="/register" method="POST" novalidate>
        ...
        <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="telefoneRegister" name="phone"
                placeholder="(99) 99999-9999" required oninput="mascaraTelefone(this)">
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                <input type="password" class="form-control" id="senhaRegister" name="password"
                    placeholder="*********" required oninput="validarConfirmacaoSenha()">
                <button class="btn btn-outline-secondary" type="button" onclick="alternarSenha('senhaRegister', this)">
