...
<body class="bg-light d-flex flex-column min-vh-100">
        ...
        <div class="col-12 col-lg-10 caixa-promocao p-3 p-md-4 rounded-4 shadow-lg">
          <div id="carouselPromocoes" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
            <div class="carousel-indicators mb-n4">
              <button type="button" data-bs-target="#carouselPromocoes" data-bs-slide-to="0" class="active" aria-current="true"></button>
              <button type="button" data-bs-target="#carouselPromocoes" data-bs-slide-to="1"></button>
              <button type="button" data-bs-target="#carouselPromocoes" data-bs-slide-to="2"></button>
              <button type="button" data-bs-target="#carouselPromocoes" data-bs-slide-to="3"></button>
              <button type="button" data-bs-target="#carouselPromocoes" data-bs-slide-to="4"></button>
            </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="card border-0 rounded-4 overflow-hidden h-100 position-relative" style="min-height: 400px">
                  <div class="row g-0 h-100">
                    <div class="col-md-6 bg-light d-flex align-items-center justify-content-center p-4 card-img-container">
                      <img src="assets/img/produtos/serra_circular_de_bancada_10_1800w_stanley_254mm_com_guia_mesa_sst1801_128453_1_4b7129a03dc8f100656f6201a5a7d383.webp" class="img-fluid card-product-img" style="max-height: 250px; object-fit: contain" alt="Serra de Bancada Stanley" />
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                      <div class="card-body p-4 p-lg-5 text-center text-md-start">
                        <h3 class="card-title fw-bold text-primary mb-3">Serra de Bancada Stanley</h3>
                        <p class="card-text text-secondary fs-5 mb-4">Potência de 1800W e alta precisão para marcenaria profissional.</p>
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                          <span class="badge bg-warning text-dark fs-5 px-3 py-2 rounded-pill shadow-sm">R$ 2.499,00</span>
              ...
              <div class="carousel-item">
                <div class="card border-0 rounded-4 overflow-hidden h-100 position-relative" style="min-height: 400px">
                  <div class="row g-0 h-100">
                    <div class="col-md-6 bg-light d-flex align-items-center justify-content-center p-4 card-img-container">
                      <img src="assets/img/produtos/zoom-1712-A7019.webp" class="img-fluid card-product-img" style="max-height: 250px; object-fit: contain" alt="Parafusadeira DeWalt 20V" />
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                      <div class="card-body p-4 p-lg-5 text-center text-md-start">
                        <h3 class="card-title fw-bold text-primary mb-3">Parafusadeira DeWalt 20V</h3>
                        <p class="card-text text-secondary fs-5 mb-4">Motor Brushless, alto torque e bateria de longa duração.</p>
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                          <span class="badge bg-warning text-dark fs-5 px-3 py-2 rounded-pill shadow-sm">R$ 1.499,00</span>
                          <a href="" class="btn btn-primary rounded-pill px-4 fw-bold stretched-link">Comprar Agora</a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="carousel-item">
                <div class="card border-0 rounded-4 overflow-hidden h-100 position-relative" style="min-height: 400px">
                  <div class="row g-0 h-100">
                    <div class="col-md-6 bg-light d-flex align-items-center justify-content-center p-4 card-img-container">
                      <img src="assets/img/produtos/martelete-makita.webp" class="img-fluid card-product-img" style="max-height: 250px; object-fit: contain" alt="Martelete Combinado Makita" />
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                      <div class="card-body p-4 p-lg-5 text-center text-md-start">
                        <h3 class="card-title fw-bold text-primary mb-3">Martelete Combinado Makita</h3>
                        <p class="card-text text-secondary fs-5 mb-4">Performance industrial para perfuração e demolição em concreto.</p>
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                          <span class="badge bg-warning text-dark fs-5 px-3 py-2 rounded-pill shadow-sm">R$ 899,90</span>
                          <a href="" class="btn btn-primary rounded-pill px-4 fw-bold stretched-link">Comprar Agora</a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="carousel-item">
                <div class="card border-0 rounded-4 overflow-hidden h-100 position-relative" style="min-height: 400px">
                  <div class="row g-0 h-100">
                    <div class="col-md-6 bg-light d-flex align-items-center justify-content-center p-4 card-img-container">
                      <img src="assets/img/produtos/ferramentas-manuais-outros-kit-ferramentas-para-mecanico-176-pcs-44952176-tramontinapro-1717183025549.webp" class="img-fluid card-product-img" style="max-height: 250px; object-fit: contain" alt="Jogo Mecânico Tramontina PRO" />
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                      <div class="card-body p-4 p-lg-5 text-center text-md-start">
                        <h3 class="card-title fw-bold text-primary mb-3">Jogo Mecânico Tramontina PRO</h3>
                        <p class="card-text text-secondary fs-5 mb-4">Maleta completa com 176 peças de alta resistência para profissionais.</p>
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                          <span class="badge bg-warning text-dark fs-5 px-3 py-2 rounded-pill shadow-sm">R$ 1.890,00</span>
                          <a href="" class="btn btn-primary rounded-pill px-4 fw-bold stretched-link">Comprar Agora</a>
                        </div>
                      </div>
                    </div>
               ...
               <div class="carousel-item">
                <div class="card border-0 rounded-4 overflow-hidden h-100 position-relative" style="min-height: 400px">
                  <div class="row g-0 h-100">
                    <div class="col-md-6 bg-light d-flex align-items-center justify-content-center p-4 card-img-container">
                      <img src="assets/img/produtos/maquina-de-solda.webp" class="img-fluid card-product-img" style="max-height: 250px; object-fit: contain" alt="Inversora de Solda" />
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                      <div class="card-body p-4 p-lg-5 text-center text-md-start">
                        <h3 class="card-title fw-bold text-primary mb-3">Inversora de Solda Digital</h3>
                        <p class="card-text text-secondary fs-5 mb-4">Portátil, bivolt e com display digital para soldas precisas.</p>
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                          <span class="badge bg-warning text-dark fs-5 px-3 py-2 rounded-pill shadow-sm">R$ 499,90</span>
                          <a href="" class="btn btn-primary rounded-pill px-4 fw-bold stretched-link">Comprar Agora</a>
                        </div>
                      </div>
                    </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-auto">
    <div class="container">
      ...
      <div class="mt-3">
        <a href="https://www.instagram.com/centerferramentasfrutal/" class="text-white mx-2"><i class="fa-brands fa-instagram fa-lg"></i></a>
        <a href="https://wa.me/5534991975188" class="text-white mx-2"><i class="fa-brands fa-whatsapp fa-lg"></i></a>
        <a href="https://www.facebook.com/people/Centeer-Ferramentas/pfbid035G3rq1SRbJfu3YWsh7Cy8Q7kCkFfnFr2DzCszxQcduFVMxRNZ2SYbhy4wcBKQYGdl/" class="text-white mx-2"><i class="fa-brands fa-facebook fa-lg"></i></a>
      </div>
    </div>
  </footer>
